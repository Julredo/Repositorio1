...
<body>
      ...
      <div id="navbar">
        ...
        <!-- logo, cambiar por uno mas decente -->
        <div class="logo">


        <a  href="#logo"><img  src="images/logo.png" alt="logo" height="50"></a>
        </div>
        <!-- fin logo -->



            <a id="elementos" href="#faq">Preguntas frecuentes</a>
            <a id="elementos" href="#Contactanos">Contactanos</a>
            <a id="elementos" href="#extra">Extra</a>

            <!-- mail y contraseña no son responsive, borrar si no hace falta -->
            <!-- <a>ingrese mail <input type="email" name="email" required value="" maxlength="20" placeholder="ejemplo@gmail.com"></a>
            <a>ingrese contraseña <input type="password" name="password" required value="" maxlength="20"></a> -->
      </div>
      <!-- fin header -->

      <!-- prueba, todo lo de abajo no sirve -->
